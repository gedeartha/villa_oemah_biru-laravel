<x-layouts.auth>
    <div class="h-screen">
        <div class="grid grid-cols-12">
            <div class="col-span-7 h-screen bg-cover bg-center"
                style="background-image: url(https://images.unsplash.com/photo-1538964173425-93884d739596?ixlib=rb-1.2.1&raw_url=true&q=80&fm=jpg&crop=entropy&cs=tinysrgb&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=735)">
            </div>
